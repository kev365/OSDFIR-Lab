...
### Changed
- Bumped `osdfir-infrastructure` chart **2.8.6 → 2.8.7** (automated). See upstream: https://github.com/google/osdfir-infrastructure/releases/tag/osdfir-infrastructure-2.8.7
